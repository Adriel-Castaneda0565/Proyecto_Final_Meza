...
<header class="header">
    ...
    <nav><ul class="nav">
            ...
            <li><a href="Productos.php">Productos</a>
                ...
                <label style="color:#00ddff;" for="btn-popup">
                    Contacto
                </label>
            </div></li>
            <?php
        ...
        echo '<p class="bienvenido">Bienvenid@, ' . htmlspecialchars($_SESSION['dinotienda']) . '</p>';
        echo '<p><br></p>';
...
<!--Productos-->
    ...
    <div class="catego">
        ...
        <img src=img/blackdragon.png class="imagen-cat">
        <p style="color:black">PELUCHES</p>
        </a>
        

        <a href="figuras.php" class="xx">
        <img src=img/vrex.png class="imagen-cat">
        <p style="color:black">FIGURAS</p>
        </a>

        <a href="Carritos.php" class="xx">
        <img src=img/tacoma.png class="imagen-cat" width="200px">
